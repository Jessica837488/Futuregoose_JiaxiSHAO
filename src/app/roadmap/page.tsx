import RoadmapContent, { type Stage } from "@/components/RoadmapContent";
...
export const metadata = {
  title: "成长路径规划 | 未来鹅 — 大一至毕业全阶段行动指南",
  description:
    "从大一新生到大四毕业生，每个阶段该做什么：打好基础、方向探索、实习冲刺、校招备战。清晰的成长地图 + 可执行的阶段任务清单，助你每一步都算数。",
  openGraph: {
    title: "成长路径规划 | 未来鹅",
    description: "从新生到毕业，每个阶段该做什么、怎么准备，一张清晰的成长地图。",
    type: "website",
  },
};
